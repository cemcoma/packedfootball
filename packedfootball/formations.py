...
_442_base = [
    ...
    {"pos": [27.0, 15.0], "role": "LCB"},
    {"pos": [43.0, 15.0], "role": "RCB"},
    {"pos": [58.0, 20.0], "role": "RB"},
    {"pos": [12.0, 40.0], "role": "LM"},
    {"pos": [27.0, 35.0], "role": "LCM"},
    {"pos": [43.0, 35.0], "role": "RCM"},
    {"pos": [58.0, 40.0], "role": "RM"},
    {"pos": [27.0, 47.0], "role": "LS"},
    {"pos": [43.0, 47.0], "role": "RS"},
]
...
_433_base = [
    ...
    {"pos": [25.0, 30.0], "role": "LCM"},
    {"pos": [45.0, 30.0], "role": "RCM"},
...
_352_base = [
    {"pos": [35.0, 5.0],  "role": "GK"},
    {"pos": [18.0, 15.0], "role": "LCB"},
    {"pos": [35.0, 12.0], "role": "CB"},
    {"pos": [52.0, 15.0], "role": "RCB"},
    {"pos": [35.0, 22.0], "role": "CDM"},
    {"pos": [10.0, 32.0], "role": "LWB"},
    {"pos": [25.0, 32.0], "role": "LCM"},
    {"pos": [45.0, 32.0], "role": "RCM"},
...
_4231_base = [
    ...
    {"pos": [43.0, 15.0], "role": "RCB"},
    {"pos": [58.0, 20.0], "role": "RB"},
    {"pos": [27.0, 28.0], "role": "LDM"},
    {"pos": [43.0, 28.0], "role": "RDM"},
    {"pos": [15.0, 38.0], "role": "LAM"},
    {"pos": [35.0, 38.0], "role": "CAM"},
    {"pos": [55.0, 38.0], "role": "RAM"},
    {"pos": [35.0, 47.0], "role": "ST"},
]
