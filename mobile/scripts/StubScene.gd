...
## functionality (shop inventory, team management, PVP matchmaking, profile)
## gets built. Shop/Team/Pvp/Profile.tscn all share this one script, each
## just setting a different `title` in its own scene file.
